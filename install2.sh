...
TARBALLURL="https://github.com/Trittium/trittium/releases/download/v3.0.2.0/Trittium-3.0.2.0-Linux.zip"
TARBALLNAME="Trittium-3.0.2.0-Linux.zip"
TRTTVERSION="3.0.2.0"
...
echo "
  ------- TRITTIUM MASTERNODE INSTALLER v3.0BX------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/Trittium/trittium/releases/download/v3.0.2.0/Trittium-3.0.2.0-Linux.zip && unzip Trittium-3.0.2.0-Linux.zip -d USERHOME/  && rm Trittium-3.0.2.0-Linux.zip
